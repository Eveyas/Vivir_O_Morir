...
//     version 1.14.2
//     from Assets/player_controler.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/player_controler.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Player_controler: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@Player_controler()
    {
        UnityEngine.Debug.Assert(!m_Move.enabled, "This will cause a leak and performance issues, Player_controler.Move.Disable() has not been called.");
    }
    ...
    {
        private @Player_controler m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MoveActions(@Player_controler wrapper) { m_Wrapper = wrapper; }
        /// <summary>
